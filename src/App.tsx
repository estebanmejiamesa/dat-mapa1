...
/**
 * Canvas Interactivo — Mapa Descriptivo del Cliente (Decisores del Sector Público)
...
const BLOCKS: readonly Block[] = [
  {
    ...
    pregunta:
      "¿Qué obstáculos (presupuestales, normativos, políticos o de talento) frenan hoy la adopción de proyectos de modernización digital en su ministerio?",
  },
  {
    id: "b2",
    numero: "02.",
    ...
    pregunta:
      "¿Qué resultados clave (eficiencia, transparencia, control fiscal, servicio al ciudadano) esperan obtener al invertir en estas iniciativas de transformación?",
  },
  {
    id: "b3",
    numero: "03.",
    ...
    pregunta:
      "¿Qué áreas de innovación (gobierno digital, ciberseguridad, inteligencia artificial, interoperabilidad) les generan mayor interés y prioridad en su gestión?",
  },
  {
    id: "b4",
    numero: "04.",
    ...
    pregunta:
      "¿Qué riesgos (continuidad operativa, ciberseguridad, compras públicas, sostenibilidad presupuestal) generan dudas a la hora de aprobar e implementar estas iniciativas?",
  },
  {
    id: "b5",
    numero: "05.",
    ...
    pregunta:
      "¿Qué legado o cambio estructural desean dejar en su ministerio a través de estas transformaciones en el mediano y largo plazo?",
  },
  {
    id: "b6",
    numero: "06.",
    ...
    pregunta:
      "¿Qué incentivos (impacto social visible, cumplimiento de metas de gobierno, premios o reconocimientos sectoriales) reforzarían su compromiso con estas iniciativas?",
  },
  {
    id: "b7",
    numero: "07.",
    ...
    pregunta:
      "¿Qué actores clave (gabinete, organismos multilaterales, entes de control, ciudadanía) influyen de forma decisiva en sus decisiones de inversión digital?",
  },
  {
    id: "b8",
    numero: "08.",
    ...
    pregunta:
      "¿Qué proveedores o consultoras tecnológicas consideran hoy como referentes en proyectos de modernización y transformación digital?",
  },
  {
    id: "b9",
    numero: "09.",
    ...
    pregunta:
      "¿Cómo describirían el nivel actual de digitalización en su ministerio (servicios en línea, interoperabilidad, datos abiertos) frente a los retos que enfrentan?",
  },
  {
    id: "b10",
    numero: "10.",
    ...
    pregunta:
      "¿Qué factores (mejorar la experiencia ciudadana, optimizar costos, fortalecer la gobernanza, generar confianza pública) impulsan a los decisores a liderar estas iniciativas?",
  },
  {
    id: "b11",
    numero: "11.",
    ...
    pregunta:
      "¿Qué evidencias concretas (reducción de trámites, ahorro de costos, mayor agilidad, adopción ciudadana) necesitan observar para validar que el proyecto ha sido exitoso?",
  },
  {
    id: "b12",
    numero: "12.",
    ...
    pregunta:
      "¿Qué experiencias anteriores de proyectos públicos (retrasos, sobrecostos, baja adopción) les dejaron insatisfacción y cómo quieren evitarlas en este nuevo enfoque?",
  },
] as const;
...
function buildTXTContent(answers: Answers): string {
  ...
  const header = [
    "🗺️ Mapa Descriptivo del Cliente – Decisores del Sector Público",
...
const CanvasDecisoresPublico: FC = () => {
  ...
  const exportTXT = () => {
    ...
    a.href = url;
    a.download = "canvas_decisores_sector_publico.txt";
    a.click();
